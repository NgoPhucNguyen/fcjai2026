...
![Tạo Task Definition](/images/4.4-AI-Backend-ECS/4.4.3-Task-Definition/step1-create-task.png)
...
![Cấu hình Tài nguyên Fargate](/images/4.4-AI-Backend-ECS/4.4.3-Task-Definition/step2-task-size.png)
...
![Cấu hình Container URI và Port](/images/4.4-AI-Backend-ECS/4.4.3-Task-Definition/step3-container-port.png)
...
![Hoàn tất tạo Task](/images/4.4-AI-Backend-ECS/4.4.3-Task-Definition/step4-create-success.png)