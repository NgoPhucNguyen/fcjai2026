...
![Truy cập ECR](/images/4.4-AI-Backend-ECS/4.4.2-Amazon-ECR/step1-navigate.png)
...
![Cấu hình Repository](/images/4.4-AI-Backend-ECS/4.4.2-Amazon-ECR/step2-config-repo.png)
...
![Nút View Push Commands](/images/4.4-AI-Backend-ECS/4.4.2-Amazon-ECR/step3-view-btn.png)
...
![Kết quả Image trên ECR](/images/4.4-AI-Backend-ECS/4.4.2-Amazon-ECR/step4-result-uri.png)